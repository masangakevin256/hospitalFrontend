...
function DoctorDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [statsRes, notificationsRes] = await Promise.all([
        axios.get("https://hospitalbackend-1-eail.onrender.com/alerts", {
  ...
  const handleNotificationClick = async (id) => {
    try {
      const token = localStorage.getItem("token");
      await axios.put(`https://hospitalbackend-1-eail.onrender.com/alerts/${id}/read`, {}, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const markAllAsRead = async () => {
    try {
      const token = localStorage.getItem("token");
      await axios.put("https://hospitalbackend-1-eail.onrender.com/alerts", {}, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  if (token) {
    try {
      ...
      username = decoded.userInfo?.username || decoded.userInfo?.name || "Doctor";
      doctorId = decoded.userInfo?.userId || decoded.userInfo?.id || "";
    } catch (error) {
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      <div className="stat-icon me-3">
                        <FaUserInjured className="text-white" size={24} />
                      </div>
                      <div>
                        <h3 className="stat-number text-white mb-0">{doctorStats.totalPatients}</h3>
                ...
                <div className="card stat-card border-0 shadow-sm bg-gradient-success">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <h3 className="stat-number text-white mb-0">{doctorStats.todayAppointments}</h3>
                        <p className="stat-label text-white-50 mb-0">Today's Appointments</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="card stat-card border-0 shadow-sm bg-gradient-warning">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <h3 className="stat-number text-white mb-0">{doctorStats.pendingAlerts}</h3>
                ...
                <div className="card stat-card border-0 shadow-sm bg-gradient-danger">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <h3 className="stat-number text-white mb-0">{doctorStats.criticalCases}</h3>
                  ...
                  <div className="card-body">
                    <div className="row g-3">
                      ...
                      <div className="col-lg-3 col-md-6">
                        ...
                        >
                          <FaCalendarCheck className="mb-2" size={20} />
                          <h6 className="fw-bold">Appointments</h6>
                          <small className="text-muted">Manage schedule</small>
                        </button>
                      </div>
                      <div className="col-lg-3 col-md-6">
                        <button 
        ...
        <div className="welcome-overlay">
          <div className="welcome-container">
            <div className="welcome-card text-center">
              <FaStethoscope className="welcome-main-icon" />
              <h2 className="welcome-title">Welcome back, Dr. {username}!</h2>
        ...
        <div className="welcome-overlay">
          <div className="welcome-container">
            <div className="welcome-card text-center">
              ...
              <p className="welcome-subtitle">Thank you for your service today!</p>
              <div className="welcome-progress-container">
      ...
      <div className="mobile-header">
        <div className="mobile-header-content">
          ...
          <div className="mobile-title-section">
            <FaStethoscope className="mobile-title-icon" />
            <h2 className="mobile-title">Doctor Dashboard</h2>
          </div>
      ...
      <div className={`doctor-sidebar ${sidebarOpen ? 'sidebar-open' : ''}`}>
        <div className="sidebar-header">
          <div className="sidebar-brand">
            ...
            <span className="brand-text">DOCTOR PANEL</span>
          </div>
          <button 
        ...
        <div className="profile-section">
          ...
          <h5 className="doctor-name">Dr. {username}</h5>
          <p className="doctor-role">Medical Practitioner</p>
            ...
            <div className="page-title-section">
              ...
              <p className="page-subtitle">
                {activeSection === "dashboard" 
                  ? "Medical overview and quick actions" 
            ...
            <div className="header-actions">
              ...
              <div className="user-profile">
                ...
                <div className="user-info">
                  ...
                  <span className="user-name">Dr. {username}</span>
                </div>
              </div>
            </div>
          </div>
