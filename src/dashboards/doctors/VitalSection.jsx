...
function VitalsSection() {
  ...
  const fetchVitals = async () => {
    try {
      ...
      const res = await axios.get("http://localhost:3500/vitals", {
  ...
  const handleAddVital = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:3500/vitals", vitalData, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleEditVital = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:3500/vitals/${selectedVital._id}`, vitalData, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleDeleteVital = async () => {
    try {
      const token = localStorage.getItem("token");
      await axios.delete(`http://localhost:3500/vitals/${selectedVital._id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
